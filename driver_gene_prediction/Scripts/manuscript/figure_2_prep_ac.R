...
#'                "/manuscript/figure_2/plot_data/pvals_TopK_ac.csv"`'
#'  type: script
#'  threads: 60  
#'  resources:
#'    - mem_mb: 20000 
...
saveRDS(snakemake, file.path(snakemake@params$projectPath,
                             "/processed_data/snakemake/figure_2_prep_ac.snakemake"))
# snakemake <- readRDS("/s/project/vale/driver_prediction_202207/processed_data/snakemake/figure_2_prep_ac.snakemake")
...
cancer_driver_lists <- cancer_driver_lists[c("all.full", "all.ocg",
                                             "leukemia.full", "leukemia.ocg")] # if plotting activation required
