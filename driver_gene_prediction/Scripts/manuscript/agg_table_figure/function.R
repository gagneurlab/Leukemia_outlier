add_result_paths <- function(exp_viz, project_dir, intogen_dir, vep_dir){
  exp_viz[model_method!='nn', res_pre_path := paste0(project_dir, '/processed_results/pre_lr_rf_xbg/result_', experiment_no, '.tsv')]
  exp_viz[model_method!='nn', coeff_path := paste0(project_dir, '/processed_results/pre_lr_rf_xbg/coess_', experiment_no, '.tsv')]
  exp_viz[model_method!='nn', res_post_path := paste0(project_dir, '/processed_results/post_lr_rf_xbg/result_', experiment_no, '.tsv')]
  exp_viz[model_method!='nn', rp_path := paste0(project_dir, '/processed_results/post_lr_rf_xbg/rp_', experiment_no, '.tsv')]

  exp_viz[model_method=='nn', res_pre_path := paste0(project_dir, '/processed_results/pre_nn/result_', experiment_no, '.tsv')]
  exp_viz[model_method=='nn', coeff_path := paste0(project_dir, '/processed_results/pre_nn/coeff_', experiment_no, '.tsv')]
  exp_viz[model_method=='nn', res_post_path := paste0(project_dir, '/processed_results/post_nn/result_', experiment_no, '.tsv')]
  exp_viz[model_method=='nn', rp_path := paste0(project_dir, '/processed_results/post_nn/rp_', experiment_no, '.tsv')]

  exp_viz[, vep_path := paste0(vep_dir, '/MLL_', toupper(sample_group), '.vep.tsv.gz')]
