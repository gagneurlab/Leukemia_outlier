...
saveRDS(snakemake, file.path(snakemake@params$projectPath,
                             "/processed_data/snakemake/generate_outrider_features_groupwise.snakemake"))
# snakemake <- readRDS("/s/project/vale/driver_prediction_202207/processed_data/snakemake/generate_outrider_features_groupwise.snakemake")
